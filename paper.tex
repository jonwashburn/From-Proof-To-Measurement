...
\begin{itemize}
\item ambda_{\mathrm{kin}},\ u(\lambda_{\mathrm{kin}})=u(\ell_{0})n\item ambda_{\mathrm{rec}},\ u(\lambda_{\mathrm{rec}})n\item 
ho20 20 12 61 79 80 81 98 701 33 100 204 250 395 398 399 400declared or bounded)
\item  \in \{1,2\}20 20 12 61 79 80 81 98 701 33 100 204 250 395 398 399 400coverage factor)
\end{itemize}
